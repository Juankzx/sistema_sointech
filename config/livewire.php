...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        'rules' => ['nullable', 'file', 'max:30720'],                                      // Increased max size to 30MB for high-res smartphone photos
    ...
    */
    ...
    'payload' => [
        'max_size' => 35 * 1024 * 1024,   // 35MB - maximum request payload size in bytes (allows photos up to 30MB)
