...
class ManageSettings extends Component
{
    ...
    public function saveService()
    {
        ...
        if ($this->editing_service_id) {
            $service = \App\Models\Service::find($this->editing_service_id);
            if ($service) {
                $service->update([
            ...
            session()->flash('message', 'Servicio agregado al catálogo correctamente.');
        }
    ...
    public function cancelServiceEdit()
    {
        $this->resetServiceForm();
    }
