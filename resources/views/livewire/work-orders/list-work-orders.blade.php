                                ...
                                <td class="px-3 py-3">
                                    <div class="flex items-center justify-center gap-2">
                                        <button 
                                            ...
                                            class="p-2 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl transition duration-150 shadow-md shadow-blue-500/10 hover:shadow-blue-500/20 cursor-pointer"
                                        ...
                                        <a 
                                            ...
                                            target="_blank" 
                                            class="p-2 bg-emerald-950/20 hover:bg-emerald-900/40 text-emerald-400 hover:text-emerald-300 rounded-xl border border-emerald-500/20 transition duration-150 cursor-pointer flex items-center justify-center shadow-sm shadow-emerald-500/10 hover:shadow-emerald-500/20 group"
                                            title="Notificar rápido por WhatsApp"
                                        >
                ...
                <div class="flex gap-2 mt-auto">
                    @if(auth()->user()->hasRole(['admin', 'tecnico', 'recepcionista']))
                        <button wire:click="openWorkOrderDetails({{ $order->id }})" class="flex-1 py-3 bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold rounded-xl transition duration-150 shadow-md shadow-blue-500/20 text-center flex items-center justify-center gap-2 active:scale-95">
                            ...
                            Gestionar
                            <svg class="w-3.5 h-3.5 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                        </button>
                        @php
                            $clientNameShort = explode(' ', $order->client->full_name)[0];
                            $waMessage = "Hola {$clientNameShort}, puedes hacer el seguimiento de la reparación de tu {$order->brand_model} en tiempo real aquí: " . url('/seguimiento/' . $order->uuid);
